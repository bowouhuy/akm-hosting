                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="form.name" placeholder="Nama Paket">
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Deskripsi</label>
                                <input type="text" class="form-control" v-model="form.description" placeholder="Deskripsi Paket">
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Harga Paket</label>
                                <input type="text" class="form-control" v-model="form.price" placeholder="Harga Paket">
                            </fieldset>
                        </div>
                    </div>
                </div>
